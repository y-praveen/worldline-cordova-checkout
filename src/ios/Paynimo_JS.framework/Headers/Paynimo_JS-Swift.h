...
#ifndef PAYNIMO_JS_SWIFT_H
#define PAYNIMO_JS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Paynimo_JS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Paynimo_JS22CheckoutViewController") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface CheckoutViewController : UIViewController <CXCallObserverDelegate, UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
